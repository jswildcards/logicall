...
CREATE TABLE "Order" (
  ...
  "sendDriverId"      INTEGER NULL REFERENCES "User"("userId"),
  "receiveDriverId"   INTEGER NULL REFERENCES "User"("userId"),
  "weight"            REAL NULL,
  "receiveDepotId"    INTEGER NULL REFERENCES "Depot"("depotId"),
  "sendDepotId"       INTEGER NULL REFERENCES "Depot"("depotId"),
  "status"            STATUS NULL,
  "qrcode"            TEXT NULL,
  "comments"          TEXT NULL,
  "createdAt"         TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
('https://picsum.photos/id/55/200', NULL, 'محمدعلی', 'كامياران', 'mhmdaaly.kmyrn@example.com', 'admin', 'sadpanda672', 'e1f3ed9c4fd35d621584356eff577be55e1025b7b18a6a09a7e06b28fcff7ad3', '31587973'),
